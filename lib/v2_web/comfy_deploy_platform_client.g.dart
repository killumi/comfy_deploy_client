...
part of 'comfy_deploy_platform_client.dart';
...
class _ComfyDeployPlatformClient implements ComfyDeployPlatformClient {
  _ComfyDeployPlatformClient(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  });
...
class _UploadImagePlatformClient implements UploadImagePlatformClient {
  _UploadImagePlatformClient(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  });
